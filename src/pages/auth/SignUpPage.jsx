...
export default function SignUpPage() {
  ...
  return (
    <div>
      ...
      <p className="text-center text-sm text-gray-600 mt-6">Already have an account? <Link to="/signin" className="text-brand-600 font-medium hover:underline">Sign In</Link></p>
    </div>
  );
}
