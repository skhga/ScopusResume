...
export default function SignUpPage() {
  ...
  return (
    <div>
      ...
      <button className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 min-h-[44px] text-sm font-medium text-gray-700 hover:bg-gray-50 mb-6">
